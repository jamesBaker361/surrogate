...
if __name__=="__main__":
	...
	num_iterations =  arg_vars["iterations"] # @param {type:"integer"}
	multi=arg_vars["mp"] #boolean
	...
	tempdir="tempmp={}{}/".format(multi,agent_variety)
...
# Triggers to save the agent's policy checkpoints.
	...
	print("total time: {}, total iterations: {}".format(finish-start,num_iterations))
	print("time per iteration: {}".format((finish-start)/num_iterations))
	rb_observer.close()
	reverb_server.stop()
